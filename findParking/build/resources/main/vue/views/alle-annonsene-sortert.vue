  ...
  <section>
    ...
    <section id="stedsorter">
      ...
      <section id="stedVelger">
        <select onchange="location = this.value;" id="steder">
          <option id="valg" v-for="annonse in annonser" v-if="annonse" :value="`sort_by/${annonse.sted}`">{{ annonse.sted }}</option>
        </select>
      </section>
    </section>
...
<script>
Vue.component("alle-annonsene-sortert", {
      template: "#annonser-sortert",
      data: () => ({
        alle_annonser: null,
        annonser: [],
      }),
